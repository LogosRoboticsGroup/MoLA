...
from semantic_tokenizer.src.trainers.latent_motion_tokenizer_trainer import LatentMotionTokenizer_Trainer
from torch.utils.data import DataLoader
from functools import partial
...
def main(cfg):
    ...
    train_dataset, eval_dataset = load_dataset(dataset_config_path, extra_data_config, "semantic")
