...
from common.data.mix_utils import DISPLAY_KEY
import cv2
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_path', type=str, default=os.getenv('OXE_TFDS_DIR', '/path/to/oxe/tensorflow_datasets'))
    parser.add_argument('--output_path', type=str, default=os.getenv('OXE_VIDEO_DIR', 'outputs/oxe_video'))
