...
class DiffusionTransformer(nn.Module):
    ...
    def forward(self, states, latent_motion_tokens_up,  actions, goals, sigma, uncond: Optional[bool] = False):
        context = self.forward_enc_only(states, latent_motion_tokens_up, actions, goals, sigma, uncond)
        pred_actions = self.forward_dec_only(context, actions, sigma)
        return pred_actions

    def forward_enc_only(self, states, latent_motion_tokens_up, actions=None, goals=None, sigma=None, uncond: Optional[bool] = False):
