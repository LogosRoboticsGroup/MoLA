...
def main(
    ...
    *_, config = inspect.getargvalues(inspect.currentframe())
    ...
    if 'clip' in train_args.clip_model_path:
        ...
        # model = T5ForConditionalGeneration.from_pretrained(train_args.clip_model_path).to("cuda")
...
# accelerate launch step1_train_svd.py --config video_conf/train_svd.yaml pretrained_model_path=/path/to/checkpoint